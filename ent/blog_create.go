...
func (bc *BlogCreate) SetNillableUserID(u *uuid.UUID) *BlogCreate {
	if u != nil {
		bc.SetUserID(*u)
	}
	return bc
...
func (bc *BlogCreate) SetOwnerID(id uuid.UUID) *BlogCreate {
	bc.mutation.SetOwnerID(id)
	return bc
}

// SetNillableOwnerID sets the "owner" edge to the User entity by ID if the given value is not nil.
func (bc *BlogCreate) SetNillableOwnerID(id *uuid.UUID) *BlogCreate {
	if id != nil {
		bc = bc.SetOwnerID(*id)
	}
	return bc
